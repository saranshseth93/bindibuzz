      ...
      <div className="container py-12">
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              Country: where Bindi Buzz or the owners/founders of Bindi Buzz are
              based, in this case is Australia
            </li>
            <li>
              Customer: refers to the company, organization or person that signs
              up to use the Bindi Buzz Service to manage the relationships with
              your consumers or service users.
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit Bindi Buzz
            ...
            <li>
              Personnel: refers to those individuals who are employed by Bindi
              Buzz or are under contract to perform a service on behalf of one
              of the parties.
            </li>
            <li>
            ...
            <li>
              Service: refers to the service provided by Bindi Buzz as described
            ...
            <li>
              You: a person or entity that is registered with Bindi Buzz to use
              the Services.
            </li>
          </ul>
        </p>
        ...
        <h1>
          When does Bindi Buzz use end user information from third parties?
        </h1>
        <p>
          Bindi Buzz will collect End User Data necessary to provide the Bindi
          Buzz services to our customers.
        </p>
        <p>
        ...
        <h1>
          When does Bindi Buzz use customer information from third parties?
        </h1>
        <p>
          ...
          interest in becoming a Bindi Buzz customer, we receive information
          from a third party that provides automated fraud detection services to
          Bindi Buzz. We also occasionally collect information that is made
        ...
        <p>
          Bindi Buzz will collect personal information that you submit to us. We
        ...
        <p>
          We keep your information only so long as we need it to provide Bindi
          Buzz to you and fulfill the purposes described in this policy. This is
        ...
        <p>
          ...
          absolute security of any information you transmit to Bindi Buzz or
        ...
        <p>
          Bindi Buzz is incorporated in Australia. Information collected via our
        ...
        <h1>
          Is the information collected through the Bindi Buzz Service secure?
        </h1>
        <p>
        ...
        <p>
          ...
          information Bindi Buzz collects depend on your relationship with Bindi
          Buzz. Personnel may update or correct their information as detailed in
        ...
        <p>
          ...
          of the assets of Bindi Buzz or any of its Corporate Affiliates (as
          defined herein), or that portion of Bindi Buzz or any of its Corporate
        ...
        <p>
          ...
          Bindi Buzz, whether by ownership or otherwise. Any information
        ...
        <h1>Governing Law</h1>
        <p>
          This Privacy Policy is governed by the laws of Australia without
        ...
        <p>
          The laws of Australia, excluding its conflicts of law rules, shall
        ...
        <p>
          By using Bindi Buzz or contacting us directly, you signify your
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by Bindi
          Buzz. We are not responsible for the content, accuracy or opinions
        ...
        <h1>Cookies</h1>
        <p>
          Bindi Buzz uses "Cookies" to identify the areas of our website that
        ...
        <p>
          You acknowledge and agree that Bindi Buzz shall not be responsible for
          ...
          or any other aspect thereof. Bindi Buzz does not assume and shall not
        ...
        <p>
          ...
          requirements of GDPR. Bindi Buzz processes or stores all personal data
        ...
        <ul>
          <li>
            Via Email:{" "}
            <a href="mailto:bindibuzz24@gmail.com">bindibuzz24@gmail.com</a>
          </li>
        </ul>
      </div>
    </>
